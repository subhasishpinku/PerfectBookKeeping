...
public class RejectGallery extends AppCompatActivity {
    ...
    CryptLib cryptLib;
    String newEncrypt, oldEncrypt, copyImageUrl,filterNamesIdSpaceRemove = "",approvalStatusNewSpaceRemove ="(3)";
    ...
    TextView fromDate, toDate, header_title, companyName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reject_gallery);
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        getWindow().setStatusBarColor(Color.TRANSPARENT);
        android.graphics.drawable.Drawable background = RejectGallery.this.getDrawable(R.drawable.gradiant_btn_alt);
    ...
    private void initialize() {
        global = new Global();
        galDb = new Manager(RejectGallery.this);
        shared = getSharedPreferences("book_keeping", Context.MODE_PRIVATE);
        /*GET SHARD PREF DATA*/
        ...
        removeFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(str_ids.equals("") || str_ids == null) {
                    Toast.makeText(RejectGallery.this, getResources().getString(R.string.choose_at_least_one_image_to_remove), Toast.LENGTH_SHORT).show();
                } else {
                    android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(RejectGallery.this);
                    ...
                    builder.setNegativeButton("YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            if(global.isNetworkAvailable(RejectGallery.this)) {
                                removeImage("Bearer "+auth, str_ids);
                            } else {
                                Toast.makeText(RejectGallery.this, getResources().getString(R.string.please_Check_Your_Internet_Connection), Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        ...
        zip_edt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (str_ids.equals("") || str_ids == null) {
                    Toast.makeText(RejectGallery.this, getResources().getString(R.string.choose_at_least_one_image_to_download), Toast.LENGTH_SHORT).show();
                } else {
                    if(global.isNetworkAvailable(RejectGallery.this)) {
        ...
        progressDialog = new Dialog(RejectGallery.this);
    ...
    private void fetchData() {
        Cursor gallery = galDb.checkGalleryImage(companyId, 3);
        ...
        if(gallery.getCount() > 0) {
            ...
            if(global.isNetworkAvailable(RejectGallery.this)) {
                loadGallery("Bearer " + auth, "", "", "", "", "", companyId, "3", "", "");
            } else {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                if (response.code() == 200) {
                    ...
                    if (response.body().get("data").isJsonObject() == false) {
                        ...
                        try {
                            ...
                            if (galleryAllItems.size() > 0) {
                                progressDialog.dismiss();
                                galleryAdapter = new GalleryAdapter(galleryAllItems, RejectGallery.this,  sectionSelections, "live");
                                galleryImages.setAdapter(galleryAdapter);
                                GridLayoutManager gridLayoutManager = new GridLayoutManager(RejectGallery.this, 4);
                    ...
                    if(token.equals("Refresh Token Expires")) {
                        clearShare();
                        startActivity(new Intent(RejectGallery.this, LoginScreen.class));
                    } else {
    ...
    public void clearShare() {
        ...
        editor.commit();
        Manager db = new Manager(RejectGallery.this);
        db.removeAllCompany();
    }
    ...
    private void showPopUp(View v) {
        PopupMenu popupMenu = new PopupMenu(RejectGallery.this, v);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if(id == R.id.companyList) {
                    Intent company = new Intent(RejectGallery.this, Companies.class);
                    company.putExtra("enable","0");
                    startActivity(company);
                } else if(id == R.id.profileDtl) {
                    startActivity(new Intent(RejectGallery.this, Profile.class));
    ...
    private void log_out() {
        progressDialog.show();
        String mac_address = global.getDeviceToken(RejectGallery.this);
            ...
            public void onResponse(Call<LogoutResponse> call, Response<LogoutResponse> response) {
                ...
                if(response.code() == 200) {
                    ...
                    try {
                        ...
                        Toast.makeText(RejectGallery.this, ""+jObjError.getString("message"), Toast.LENGTH_SHORT).show();
                    } catch (JSONException e) {
                        throw new RuntimeException(e);
                    } catch (IOException e) {
                        throw new RuntimeException(e);
    ...
    private void openSheet() {
        sheetDialog = new BottomSheetDialog(RejectGallery.this, R.style.BottomSheetStyle);
            ...
            public void onClick(View v) {
                ...
                if(oldPassword.getText().toString().equals("")) {
                    ...
                    if(global.isNetworkAvailable(RejectGallery.this)) {
                        ...
                        Toast.makeText(RejectGallery.this, please_Check_Your_Internet_Connection, Toast.LENGTH_SHORT).show();
                    }
    ...
    private void passwordUpdate(String newEncrypt, String oldEncrypt) {
        ...
        changePassword.enqueue(new Callback<ChangePassword>() {
            ...
            public void onResponse(Call<ChangePassword> call, Response<ChangePassword> response) {
                if(response.code() == 200) {
                    progressDialog.dismiss();
                    Toast.makeText(RejectGallery.this, getResources().getString(R.string.password_change_successfully), Toast.LENGTH_SHORT).show();
                    sheetDialog.dismiss();
                } else {
                    progressDialog.dismiss();
                    try {
            ...
            public void onResponse(Call<FilterSubUserResponse> call, Response<FilterSubUserResponse> response) {
                ...
                if(response.code() == 200) {
                    ...
                    if(filterUsers.size() > 0) {
                        filterUserAdapter = new RejectGallery.FilterUserAdapter(filterUsers, RejectGallery.this);
                        user_list.setAdapter(filterUserAdapter);
                        user_list.setLayoutManager(new LinearLayoutManager(RejectGallery.this));
                        filterUserAdapter.notifyDataSetChanged();
                    }
                } else {
                    progressDialog.dismiss();
                    Toast.makeText(RejectGallery.this, getResources().getString(R.string.opps_Try_again_later), Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void SubUser(int companyId) {
        ...
        if(getSubUser.getCount() > 0) {
            while (getSubUser.moveToNext()) {
                ...
                if(filterUsers.size() > 0) {
                    filterUserAdapter = new FilterUserAdapter(filterUsers, RejectGallery.this);
                    user_list.setAdapter(filterUserAdapter);
                    user_list.setLayoutManager(new LinearLayoutManager(RejectGallery.this));
                    filterUserAdapter.notifyDataSetChanged();
                }
    ...
    public void redirect(){
        if(galleryAllItems.size() > 0) {
            if(galleryAdapter.checkBoxVisible == true) {
                ...
                Intent businessDashboard = new Intent(RejectGallery.this, BusinessDashboards.class);
    ...
    private void loadGallery_zip(String auth, String ids, boolean zip) {
        ...
        gallery.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                if (response.code() == 200) {
                    progressDialog.dismiss();
                    Toast.makeText(RejectGallery.this, getResources().getString(R.string.receipts_downloading_started), Toast.LENGTH_SHORT).show();
    ...
    private void downloadFile(String url, String fileName) {
        ...
        DownloadManager downloadManager = (DownloadManager) RejectGallery.this.getSystemService(Context.DOWNLOAD_SERVICE);
        downloadManager.enqueue(request);
    }

    @SuppressLint("MissingInflatedId")
    private void openSort() {
        bottomsheetdialog = new BottomSheetDialog(RejectGallery.this, R.style.BottomSheetStyle);
        View sort = LayoutInflater.from(RejectGallery.this).inflate(R.layout.sort_bottom_sheet, null);
    ...
    private void openFilter() {
        bottomsheetdialog = new BottomSheetDialog(RejectGallery.this, R.style.BottomSheetStyle);
        View filter = LayoutInflater.from(RejectGallery.this).inflate(R.layout.filter_bottomsheet, null);
        ...
        reset_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toDates = "";
                filterApply = 0;
                approvalStatusNewSpaceRemove = "(3)";
...
//        bottomSheetBehavior.setState(BottomSheetBehavior.STATE_SETTLING);
    ...
    private void syncFilterData(String fromDates,String toDates,String approvalStatus,String uploadById, String searchBy,String orderBy, int filterApply) {
        ...
        if (filterGallery.getCount() > 0){
            ...
            if (galleryAllItems.size() > 0) {
                progressDialog.dismiss();
                galleryAdapter = new GalleryAdapter(galleryAllItems, RejectGallery.this,  sectionSelections, "loacl");
                galleryImages.setAdapter(galleryAdapter);
                GridLayoutManager gridLayoutManager = new GridLayoutManager(RejectGallery.this, 4);
                gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                    @Override
